        ...
        <>
            ...
            >
                <h3
                    ...
                    className="font-extrabold text-4xl md:text-5xl tracking-tight text-white"
                >
                    {title}
                </h3>
                <p
...
const HeroBanner = () => {
    return (
        <section
            className="max-w-5xl w-full aspect-3/4 md:aspect-video bg-center bg-cover bg-no-repeat my-0 mx-auto overflow-hidden rounded-xl
